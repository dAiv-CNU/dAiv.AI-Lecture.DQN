...
class SnakeBoard:
    ...
    def __init__(self, s, genome):
        ...
        self.snake = np.array(
            [[center_x, center_y], [center_x, center_y + 1], [center_x, center_y + 2], [center_x, center_y + 3]])
    ...
    def run(self):
        ...
        while True:
            ...
            pygame.draw.rect(self.s, (255, 255, 255), [
                0, 0, config.SCREEN_SIZE * config.PIXEL_SIZE, config.LINE_WIDTH
            ])
            pygame.draw.rect(self.s, (255, 255, 255), [
                0,
                config.SCREEN_SIZE * config.PIXEL_SIZE - config.LINE_WIDTH,
                config.SCREEN_SIZE * config.PIXEL_SIZE,
                config.LINE_WIDTH
            ])
            pygame.draw.rect(self.s, (255, 255, 255), [
                0, 0, config.LINE_WIDTH, config.SCREEN_SIZE * config.PIXEL_SIZE
            ])
            pygame.draw.rect(self.s, (255, 255, 255),[
                config.SCREEN_SIZE * config.PIXEL_SIZE - config.LINE_WIDTH,
                0,
